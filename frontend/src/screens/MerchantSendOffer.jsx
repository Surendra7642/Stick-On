...
export default function MerchantSendOffer({ onNext, onBack }) {
  return (
    <div className="screen send-offer-container fade-in scrollable">
      ...
      <h1 className="title left-align" style={{ fontSize: '24px', marginBottom: '24px' }}>Send offer to Ravi Kumar</h1>
      ...
      <div className="candidate-card" style={{ background: '#FAF8F5', borderRadius: '16px', padding: '16px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '32px' }}>
        <div style={{ display: 'flex', alignItems: 'center' }}>
          <div style={{ color: '#342056', fontWeight: 500, marginRight: '16px' }}>RK</div>
          <div>
            <p style={{ margin: 0, fontWeight: 500, color: '#342056', fontSize: '15px', marginBottom: '4px' }}>Ravi Kumar · Intermediate</p>
            <p style={{ margin: 0, fontSize: '13px', color: '#342056' }}>Telugu, Hindi, English</p>
          </div>
        </div>
      ...
      <div style={{ display: 'flex', gap: '24px', marginBottom: '24px' }}>
        <div className="form-group" style={{ flex: 1, marginBottom: 0 }}>
          ...
          <p style={{ margin: 0, padding: '12px 0 8px 16px', borderBottom: '1px solid #E5DFD5', fontSize: '15px' }}>28 Apr 2026</p>
        </div>
        <div className="form-group" style={{ flex: 1, marginBottom: 0 }}>
      ...
      <button className="primary-button" style={{ marginTop: 'auto', marginBottom: '24px' }} onClick={onNext}>
        Send offer + notify candidate &rarr;
      </button>
    </div>
  );
}
